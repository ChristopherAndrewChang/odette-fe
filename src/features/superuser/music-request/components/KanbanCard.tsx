...
function KanbanCard({
  ...
  return (
    <div
      className={classNames('bg-gray-50 p-4 rounded-lg border w-full min-w-0', {
    ...
    >
      <div className={classNames('flex justify-between gap-4 min-w-0', { '!mb-2': compact })}>
        <p
          className={classNames('font-medium text-black break-words min-w-0', {
      ...
      {!compact ? <p className='text-sm mb-4'>{artist}</p> : null}

      {/* table identity */}
      <div className='flex items-center gap-2 flex-wrap min-w-0'>
        <div
          className={classNames('px-4 py-1 flex items-center justify-center bg-gray-200 rounded-lg', {
