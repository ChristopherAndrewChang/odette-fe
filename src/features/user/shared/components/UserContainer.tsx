...
function UserContainer({ children, isDj }: TUserContainer) {
  ...
  const getGridValue = () => {
    ...
    return arr?.length + 2 // ini buat tambah game dan feedback karena game selalu show
  }

  return (
    <div
      className={classNames('mx-auto p-6 max-w-4xl scroll-smooth mb-20', {
        '!max-w-5xl': isDj
      })}
      style={{
          ...
          {isFetching ? (
            ...
            <>
              {data?.data?.menu_enabled ? (
                ...
                >
                  <i
                    className={classNames('tabler-tools-kitchen', 'text-white', {
              ...
              {data?.data?.screen_request_enabled ? (
                ...
                >
                  <i
                    className={classNames('tabler-screen-share', 'text-white', {
              ...
              {data?.data?.song_request_enabled ? (
                ...
                >
                  <i
                    className={classNames('tabler-music', 'text-white', {
              ...
              >
                <i
                  className={classNames('tabler-dice', 'text-white', {
              ...
              >
                <i
                  className={classNames('tabler-message', 'text-white', {
