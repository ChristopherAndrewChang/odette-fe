...
function SongRequest() {
  const defaultValue: TSongRequest = {
    artist: '',
    donation_amount: '',
    song_title: '',
    donation: ''
  ...
  const { control, setValue, watch, handleSubmit, reset } = useForm<TSongRequest>({
  ...
  const [paymentDialogState, setPaymentDialogState] = useState<{ cond: boolean; data: TSongRequest | null }>({
    cond: false,
    data: null
  })
  ...
  const onSubmit = (data: TSongRequest) => {
