...
import { Button, CircularProgress, Dialog, DialogContent, Typography, useColorScheme } from '@mui/material'
...
function UserScan() {
  ...
  const renderNoToken = (
    <div>
      <Typography>
        Your session has ended or no token was found. Please scan the QR code to start a new session.
      </Typography>
    </div>
  )
      ...
      <DialogContent>
        {getParam('token') ? (
          <div>
            ...
            <Typography
              className={classNames('font-outfit text-xl font-semibold text-black text-center mb-4', {
