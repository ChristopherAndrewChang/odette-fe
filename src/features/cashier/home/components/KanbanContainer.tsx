...
function KanbanContainer({ songRequestSlot, runningTextSlot, vtronImageSlot, vtronTextSlot }: TKanbanContainer) {
    return (
        <div className="flex overflow-x-scroll h-full min-h-0">
            <section className="min-w-96 border-r border-r-gray-700 p-2 flex flex-col h-full min-h-0">
                {songRequestSlot}
            </section>
            <section className="min-w-96 border-r border-r-gray-700 p-2 flex flex-col h-full min-h-0">
                {runningTextSlot}
