...
const CustomTextField = forwardRef((props: TextFieldProps & { borderless?: boolean }, ref) => {
  const { size = 'small', borderless, InputLabelProps, ...rest } = props
        ...
        borderless
          ? {
            '& .MuiInputBase-root': {
              ...
              padding: '0 !important',
              outline: 0,
              minHeight: 'unset !important', // lock height
            },
            '& .MuiInputBase-root.Mui-focused': {
              ...
              borderWidth: 0,
              padding: '0 !important',
              minHeight: 'unset !important', // keep height when focused
            },
            '& .MuiInputBase-input': {
              padding: '0 !important',
              height: 'auto', // prevent shrinking
            },
